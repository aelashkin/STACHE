...
- [ ] P0 — restore collection and installed-package/CLI baseline
...
- [ ] P1 — implement immutable generic connector/result/search/continuation contracts
...
- [ ] P2 — implement cached model/table/table-then-model action oracles
...
- [ ] P3 — implement and migrate the Taxi connector and consumers
...
- [ ] P4 — implement safe artifacts, DQN compatibility, and `stache compute-rr`
...
- [ ] P5 — document architecture, migration, rollback, and MiniGrid deferral
